...
public class Grass extends Block{
	...
	public void destroy(int x2, int y2) {
		Component.level.block[x2][y2] = new Dirt(new Rectangle((x2+(Component.level.chunkSize * Component.level.chunkOffsetX)) * Tile.tileSize, (y2 +(Component.level.chunkSize * Component.level.chunkOffsetY))* Tile.tileSize,Tile.tileSize, Tile.tileSize),Tile.earth);
